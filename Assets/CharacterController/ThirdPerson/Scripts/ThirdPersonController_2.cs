...
namespace CharacterController.ThirdPerson
{
    public class ThirdPersonController_2 : MonoBehaviour
    {
        ...
        {
            //Rigidbody.velocity += transform.forward * thrust * Time.deltaTime;
            Rigidbody.velocity += Vector3.forward * thrust * Time.deltaTime;
            if (Rigidbody.velocity.z > 6)
                Rigidbody.velocity = new Vector3(0, 0, 6);
        }
        ...
        {
#if Debug
            Debug.Log("TH2 Velocity" + Rigidbody.velocity);
#endif
        }
